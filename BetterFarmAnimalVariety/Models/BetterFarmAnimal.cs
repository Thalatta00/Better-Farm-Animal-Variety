...
{
    public class BetterFarmAnimal : StardewValley.FarmAnimal
    {
        ...
        public BetterFarmAnimal(string type, long myID, long ownerID)
        {
            ...
            ((NetFieldBase<int, NetInt>)this.health).Set(BetterFarmAnimal.HEALTH_DEFAULT);
        ...
        {
            Data_FarmAnimals FarmAnimalData = new Data_FarmAnimals();
            ...
            ((NetFieldBase<int, NetInt>)this.defaultProduceIndex).Set(Int32.Parse(DataArr[Data_FarmAnimals.DEFAULT_PRODUCE_INDEX]));
            ((NetFieldBase<int, NetInt>)this.deluxeProduceIndex).Set(Int32.Parse(DataArr[Data_FarmAnimals.DELUXE_PRODUCE_INDEX]));
            ((NetFieldBase<string, NetString>)this.sound).Set(DataArr[4].Equals(BetterFarmAnimal.NONE) ? (string)null : DataArr[4]);
            ...
            ((NetFieldBase<string, NetString>)this.toolUsedForHarvest).Set(DataArr[22].Equals(BetterFarmAnimal.NONE) ? "" : DataArr[22]);
        ...
        {
            return (new FarmAnimalSprites(this)).DetermineFilePath();
        }

        public BetterFarmAnimal RandomizeLocation(AnimalHouse animalHouse)
        {
